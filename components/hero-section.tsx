        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center lg:min-h-[70vh]">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Hey, I'm <span className="text-foreground font-medium">Anwar Nasir</span> — a self-taught senior mobile
              engineer. I mostly work with Flutter but I've proven skills in full-stack web and mobile development,
              crafting well-designed, awesome-looking apps. Follow my journey on{" "}
              <a
                href="https://t.me/software_guy"
                target="_blank"
