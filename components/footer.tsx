import { Github, Twitter, Mail, ExternalLink, Heart, Linkedin } from "lucide-react"
...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/AnexDev1", handle: "@AnexDev1", icon: Github },
  { label: "Twitter", href: "https://twitter.com/n3x0dev", handle: "@n3x0dev", icon: Twitter },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/anwar-nasir-223a96296/",
    handle: "Anwar Nasir",
    icon: Linkedin,
  },
  { label: "Telegram", href: "https://t.me/software_guy", handle: "@software_guy", icon: TelegramIcon },
  { label: "Email", href: "mailto:anwarnasir0970@gmail.com", handle: "anwarnasir0970@gmail.com", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <p className="max-w-md text-base sm:text-lg text-muted-foreground leading-relaxed">
              Always interested in collaborations, interesting problems, and conversations about mobile development,
              Flutter, and everything in between.
            </p>

            <div className="pt-2">
              <a
                href="mailto:anwarnasir0970@gmail.com"
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} ANEXON — All projects reserved
          </p>
        </div>
      </div>
    </footer>
