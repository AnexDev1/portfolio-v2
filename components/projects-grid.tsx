...
const projects = [
  {
    ...
    title: "Noor",
    description:
      "A comprehensive Islamic app built with Flutter featuring prayer times, Quran reader, Tasbih counter, Qibla compass, Hadith collections, and daily Islamic content with beautiful Material 3 design.",
    tags: ["Flutter", "Dart", "Riverpod", "Material 3", "Islamic"],
    status: "shipped",
    year: "2024",
    stars: 45,
    forks: 12,
  ...
  },
  {
    ...
    title: "Ethio Cal",
    description:
      "Ethiopian Calendar app with home screen widget support. Features Ethiopian date conversion, holidays, and a beautiful native widget for quick access.",
    tags: ["Flutter", "Dart", "Widgets", "Calendar"],
    status: "shipped",
    year: "2024",
    stars: 9,
    forks: 3,
  ...
  },
  {
    ...
    title: "JMarket",
    description:
      "A full-featured e-commerce mobile app built with Flutter and Supabase backend. Features product listings, cart management, and a stunning UI for seamless shopping.",
    tags: ["Flutter", "Supabase", "E-commerce", "Dart"],
    status: "shipped",
    year: "2024",
    stars: 18,
    forks: 5,
  ...
  },
  {
    ...
    title: "NativeChat",
    description:
      "A context-aware chat application powered by Google's Gemini AI. Features intelligent conversations with support for Ethiopian languages and cultural context.",
    tags: ["Flutter", "Gemini AI", "Dart", "Chat"],
    status: "shipped",
    year: "2024",
    stars: 14,
    forks: 4,
  ...
  },
  {
    ...
    title: "EchoLog",
    description:
      "Audio notes app that lets you record, organize, and manage voice memos with ease. Available on Google Play Store with intuitive UI and offline support.",
    tags: ["Flutter", "Audio", "Dart", "Mobile"],
    status: "shipped",
    year: "2024",
    stars: 11,
    forks: 2,
  ...
  },
  {
    ...
    title: "JIT Hub",
    description:
      "Student companion app for Jimma Institute of Technology. Features course schedules, campus resources, announcements, and academic tools for JIT students.",
  ...
  },
  {
    ...
    description:
      "Flutter SDK for integrating Hasab AI - an Ethiopian language AI model. Enables developers to add Amharic and other Ethiopian language AI capabilities to their apps.",
    tags: ["Flutter", "SDK", "AI", "Dart", "Ethiopian"],
    status: "in-progress",
    year: "2025",
    stars: 6,
    forks: 1,
    url: "https://github.com/AnexDev1/hasab-ai-flutter",
    featured: true,
  },
  {
    id: 7,
    title: "VeriPay",
    description:
      "Payment verification web app for Ethiopian banks and mobile money platforms. Fast, secure, and reliable verification for businesses across Telebirr, CBE, and more.",
    tags: ["Next.js", "TypeScript", "Payments", "Web"],
    status: "shipped",
    year: "2025",
    stars: 12,
    forks: 4,
    url: "https://github.com/AnexDev1/veripay",
