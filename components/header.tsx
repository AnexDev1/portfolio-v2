...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/AnexDev1", icon: Github },
  { label: "Twitter", href: "https://twitter.com/n3x0dev", icon: Twitter },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/anwar-nasir-223a96296/", icon: Linkedin },
  { label: "Telegram", href: "https://t.me/software_guy", icon: TelegramIcon },
]
